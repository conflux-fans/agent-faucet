...
2. Use the selected deployment's configured `rpcUrl` by default. Only ask the user for an RPC URL if the deployment does not provide one or the user explicitly wants to override it.
